		...
		<table>
			...
			<tr>
				<td>
					...
					<a class="btn btn-sm btn-outline-danger" onclick="information('Waktu Pengambilan Buku 1x24 jam dari Booking!!!')" href="<?php echo base_url() . 'booking/exportToPdf/' . $this->session->userdata('id_user'); ?>" target="_blank"><span class="far fa-lg fa-fw fa-file-pdf"></span> Pdf</a>
